...
/** !!_SITE_MONITOR_FB_!! */
include_once("/xampp/htdocs/Scale Up/test-scale-up/index.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="bg-red-700 mx-auto text-center py-2">
        <h1 class="text-xl text-white font-bold mx-4 sm:mx-0">
            Seniors On Medicare Can Get Hundreds In Savings. <strong>Tap Below To Qualify!</strong>
        </h1>
    </div>
    <div id="mainContainer" class="mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl text-center container">
        ...
        <p class="my-7 md:text-xl" style="text-align: left;">
        ...
        <div>
            <div id="display1" class="md:mt-8 mt-4">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <button id="btn-under-64" class="flex justify-center bg-green-500 hover:bg-green-500 tracking-wide text-white font-bold rounded-2xl w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center">Under 64</button>
                    <button id="btn-1" class="flex justify-center bg-green-500 hover:bg-green-500 tracking-wide text-white font-bold rounded-2xl w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center">64 - 75</button>
                    <button id="btn-2" class="flex justify-center bg-green-500 hover:bg-green-500 tracking-wide text-white font-bold rounded-2xl w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center">76 and older</button>
                </div>
            </div>
            <div id="display2" class="md:mt-8 mt-4 hidden">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <button id="btn-yes" class="flex justify-center bg-green-500 hover:bg-green-500  tracking-wide text-white font-bold rounded-2xl w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center cta_btn btn_2">Yes</button>
                    <button id="btn-no" class="flex justify-center bg-green-500 hover:bg-green-500  tracking-wide text-white font-bold rounded-2xl w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center cta_btn btn_2">No</button>
                </div>
            </div>
        </div>
    </div>
    <div id="display4" class="hidden hidden mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl container">
        <div class="p-6 border-t-2 border-blue-500 mt-4 bg-gray-300 text-center shadow-xl">
            ...
            <p class="text-xl md:text-2xl font-bold mb-4">
                You Pre-Qualify For <span class="text-blue-600">Don't miss out - Speak to an official agent to claim your benefit card now.</span>
            </p>
            <p>
                Tap below to speak to an official agent to claim your benefit card!
            </p>
            <a href="tel:+18444870575">
            ...
            <p class="mb-4">
                Due to high call volume, your official agent is only waiting for <span class="text-bold">3 minutes...</span> then your spot will not be held and will be given to the next caller.
            </p>
    ...
    <section id="progress-container" class="hidden flex justify-center items-center flex-col mt-10 mb-10 w-50">
        <div id="progress-bar" class="flex justify-center items-center flex-col ">
            ...
            <div class="progress-bar__container" style="width: 50%; height: 2rem; border-radius: 2rem; position: relative; overflow: hidden; transition: all 0.5s; will-change: transform; box-shadow: 0 0 5px #ffc438;">
                <div class="progress-bar" style="position: absolute; height: 100%; width: 100%; background-color: #ffc438; top:0; bottom: 0; left: -100%; border-radius: inherit; display: flex; justify-content: center; align-items:center; color: white; font-family: sans-serif;"></div>
            </div>
        </div>
    </section>
    <footer class="footer mt-10 footer-center p-4 mt-12 mb-2 text-center max-w-6xl mx-auto text-xs">
    ...
    <script>
        ...
        const loadRingba = () => {
            ...
            script.src = "<?php echo isset($ringbaScriptPrimary) ? $ringbaScriptPrimary : ''; ?>";
        ...
        btnNo.addEventListener("click", () => {
            display2.style.display = "none";
            window.location.href = "<?php echo isset($mbOfferSite) ? $mbOfferSite : ''; ?>";
            display5.style.display = "block";
        });

        document.getElementById("btn-under-64").addEventListener("click", function() {
